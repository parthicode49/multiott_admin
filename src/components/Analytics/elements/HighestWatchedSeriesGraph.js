...
import { highest_watched_series_graph } from "../../../actions/analytics";
...
const HighestWatchedSeriesGraph = () => {
  ...
  useEffect(() => {
    if (user) {
      ...
      dispatch(highest_watched_series_graph(data));
    }
  }, [user]);
  const data = useSelector(
    (state) => state.analytics.highest_watched_series_graph
  );
  console.log(data ,"newweofsdfdsio")
  // Chart
  const series =
