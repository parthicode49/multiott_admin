...
import { lowest_watched_song } from '../../../actions/analytics';
import { useDispatch,useSelector } from 'react-redux';
const LowestWatchedSong = () => {
  ...
  useEffect(()=>{
    if(user){
      ...
      dispatch(lowest_watched_song(data))
      // dispatch(user_watch_count_graph(data))
    }
  },[user])
  const data = useSelector((state) => state.analytics.lowest_watched_song);
...
export default LowestWatchedSong;
