...
import { highest_watched_song_graph } from '../../../actions/analytics';
...
const HighestWatchedMoviesGraph = () => {
  ...
  useEffect(()=>{
    if(user){
      ...
      dispatch(highest_watched_song_graph(data))
    }
	},[user])
  const data = useSelector((state) => state.analytics.highest_watched_song_graph);
