...
import {  lowest_watched_series_graph } from '../../../actions/analytics';
import { useDispatch,useSelector } from 'react-redux';
const LowestWatchedSeries = () => {
  ...
  useEffect(()=>{
    if(user){
      ...
      dispatch(lowest_watched_series_graph(data))
      // dispatch(user_watch_count_graph(data))
    }
  },[user])
  const data = useSelector((state) => state.analytics.lowest_watched_series);
...
export default LowestWatchedSeries;
