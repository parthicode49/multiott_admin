            ...
            <TableBody>
              {(rowsPerPage > 0
                ...
                <TableRow key={row.profileName}>
                  ...
                  >
                   <p style={{color:"var(--themeFontColor)"}}>{row.profileName}</p> 
                  </TableCell>
                  ...
                  >
                   <img src={IMAGE+row?.avatar?.avatarImage} height={"30px"}/> 
                  </TableCell>
                  ...
                  >
                    <span className={row.badgeClass} style={{color:"var(--themeFontColor)"}}>{row.deviceName}</span>
                  </TableCell>
                  ...
                  <TableCell
                    ...
                    align="center"
                  >
                    <p style={{color:"var(--themeFontColor)"}}>{row.last_login}</p>
                  </TableCell>
                </TableRow>
              ))}
