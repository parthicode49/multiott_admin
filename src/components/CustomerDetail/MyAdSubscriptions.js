    ...
    <>
      ...
      >
        ...
        >
          ...
          >
           Advertisement Subscription History
          </Typography>
        </Box>
            ...
            <TableBody>
              {(rowsPerPage > 0
                ...
                <TableRow key={row?.id}>
                  ...
                  >
                    <p style={{color:"var(--themeFontColor)"}}>{row?.advertisement_plan}</p>
                  </TableCell>
                  ...
                  >
                     <p style={{color:"var(--themeFontColor)"}}>{parseFloat(row?.advertisement_price).toFixed(2)}</p>
                  </TableCell>
                  ...
                  >
                     <p style={{color:"var(--themeFontColor)"}}>{row?.created_at}</p>
                  </TableCell>
                  {/* <TableCell
                    align="center"
                    sx={{
                ...
                <p style={{color:"var(--themeFontColor)"}}>{row?.user?.firstName+" "+row?.user?.lastName}</p>
                  ...
                  <TableCell
                    ...
                    align="center"
                  >
                     <p style={{color:"var(--themeFontColor)"}}>{row?.expire_date}</p>
                  </TableCell>
                </TableRow>
              ))}
